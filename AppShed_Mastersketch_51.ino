/*
  ...
  v 46.2 - removed 'while' from lop aREST handle.
  v 47 - Changed Wifi to WiFi
  v 48 - Commented out neopixel, maked AP name and password easier for user to find and change
  v 49 - Changed structure of code to help user set AP name and password without confusion / fixed bugges with commented neopixel
  v 50 - Added stablility 
  v 51 - changed the way master sketch sends data to appshed.com
...
*/
  ...
  readPins(""); // if the clientAP exists, it means we probably need latest pin values
